...
2. To practice loops for repeated input.

3. To learn functions for modular code.

4. To handle invalid user input gracefully.

5. To apply Python concepts to a real-life grading system.
